...
LANGUAGES.ru = {
  ...
  darkModeTogglerHelp: "Тёмная тема",
  ...
  fclTitle: "FCL",
  fclExpansion: "Библиотека классов фреймворка",
  ...
  clsDescription: "Соглашение между разработчиками языка и разработчиками фреймворка (библиотеки классов). Определяет подмножество CTS и набор соглашений об использовании",

  noExplicitImplementationsTitle: "Нет явных реализаций",
  noExplicitImplementationsDescription: "Эти спецификации не предполагают явной реализации. Они просто определяют правила, которых должны придерживаться разработчики при реализации CLI",
}
